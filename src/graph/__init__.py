    ...
    class TestApp(App):
        ...
        def build(self):
            ...
            colors = itertools.cycle([
                rgb('33b5e5'), rgb('ffff1c'), rgb('ff861c'), rgb('e5b060')])
            graph_theme = {
                'label_options': {
                    'color': rgb('dddddd'),  # color of tick labels and titles
                    'bold': True},
                'background_color': rgb('505050'),  # back ground color of canvas
                'tick_color': rgb('dddddd'),  # ticks and grid
                'border_color': rgb('dddddd')}  # border drawn around each graph
